    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
          ...
          {/* Replace this entire content section with your actual privacy policy */}
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Snaplicant.
...
Website refers to Snaplicant, accessible from http://snaplicant.com
...
Their Privacy Policy can be viewed at https://www.mailerlite.com/legal/privacy-policy?_gl=1gz1j21_upMQ.._gs*MQ..&gclid=Cj0KCQjw-NfDBhDyARIsAD-ILeBaEib2SECV_XYTJ1Tz9MzeQr-2bbfllAG44mDgkdpFcIKNogukEecaAiMXEALw_wcB&gbraid=0AAAAADlbvHoeoYf_Fi9QmzQljZ7YPScOI
...
By email: support@snaplicant.com

By visiting this page on our website: http://www.snaplicant.com/support
...
By visiting this page on our website: http://www.snaplicant.com/support</strong>
              </p>
